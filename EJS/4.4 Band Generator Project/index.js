...
app.post("/submit", (req, res) => {
  ...
  const index1=Math.floor(Math.random()*adj.length)
  const index2=Math.floor(Math.random()*noun.length)
  const randAdjective=adj[index1]
  const randNoun= noun[index2]
  console.log(index1,index2,randAdjective,randNoun)
  res.render('index.ejs',{ Adjective: randAdjective, Noun: randNoun})
